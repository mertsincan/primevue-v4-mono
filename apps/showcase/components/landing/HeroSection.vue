        ...
        <div class="flex flex-wrap">
            <div class="w-full xl:w-6/12 flex flex-col justify-center lg:pr-20 items-center xl:items-stretch">
                ...
                <p class="xl:text-left text-center px-0 mt-0 mb-8 text-surface-500 dark:text-surface-400 font-medium text-xl leading-relaxed">
                    Enhance your web applications with primevuelab's comprehensive suite of customizable, feature-rich UI components. With primevuelab, turning your development vision into reality has never been easier.
                </p>
                <div class="flex items-center gap-4">
                    ...
                    <a href="https://github.com/primefaces/primevuelab" target="_blank" rel="noopener noreferrer" class="linkbox">
                                    ...
                                    <Select v-model="user" :options="users" optionLabel="name" placeholder="Select a User" class="w-full">
                                        <template #option="slotProps">
                                            <div class="flex items-center gap-2">
                                                <img :alt="slotProps.option.name" :src="`https://primefaces.org/cdn/primevuelab/images/avatar/${slotProps.option.image}`" width="28" />
                    ...
                    <div class="flex flex-col w-6/12 gap-8 pl-4">
                        <div class="box p-6 animate-fadein animate-duration-500">
                            <div class="mb-6 w-full text-center p-8" style="border-radius: '10px'">
                                <img src="https://primefaces.org/cdn/primevuelab/images/landing/air-jordan-noir.png" alt="Watch" class="w-40" />
                            </div>
