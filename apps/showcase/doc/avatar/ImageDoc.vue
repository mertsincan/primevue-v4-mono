<template>
    ...
    <div class="card">
        <div class="flex flex-wrap gap-8">
            <div class="flex-auto">
                <h5>Image</h5>
                <Avatar image="https://primefaces.org/cdn/primevue-lab/images/avatar/amyelsner.png" class="mr-2" size="xlarge" shape="circle" />
                <Avatar image="https://primefaces.org/cdn/primevue-lab/images/avatar/asiyajavayant.png" class="mr-2" size="large" shape="circle" />
            ...
            <div class="flex-auto">
                ...
                <OverlayBadge value="4" severity="danger" class="inline-flex">
                    <Avatar class="p-overlay-badge" image="https://primefaces.org/cdn/primevue-lab/images/organization/walter.jpg" size="xlarge" />
                </OverlayBadge>
            </div>
