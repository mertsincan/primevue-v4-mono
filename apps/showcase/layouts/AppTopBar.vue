    ...
    <div :ref="containerRef" class="layout-topbar">
        <div class="layout-topbar-inner">
            <div class="layout-topbar-logo-container">
                <PrimeVueNuxtLink to="/" class="layout-topbar-logo" aria-label="primevuelab logo">
                ...
                <PrimeVueNuxtLink to="/" class="layout-topbar-icon" aria-label="primevuelab logo">
            ...
            <ul class="topbar-items">
                ...
                <li>
                    <a href="https://github.com/primefaces/primevuelab" target="_blank" rel="noopener noreferrer" class="topbar-item">
                    ...
                    <div class="versions-panel hidden">
                        <ul>
                            <li v-for="version in versions" :key="version.version" role="none">
                                <a :href="version.url">
                                    <span>primevuelab {{ version.name }}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
    ...
    data() {
        return {
            versions: [
                {
                    name: 'v4',
                    url: 'https://v4.primevuelab.org'
                },
                {
                    name: 'v3',
                    url: 'https://www.primevuelab.org'
                },
                {
                    name: 'v2',
                    url: 'https://www.primefaces.org/primevuelab-v2'
                }
            ]
        };
    },
