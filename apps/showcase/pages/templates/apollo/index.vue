<template>
    <div class="apollo template">
        ...
        <ApolloSeparator />
        <div class="hidden">
            <TemplateYoutube imgSrc="https://primefaces.org/cdn/primevuelab/images/templates/apollo/apollo-youtube-screen.png" />
            <ApolloSeparator />
        </div>
        ...
        <TemplateFeaturesAnimation :featuresData="animationFeaturesData1">
            ...
            <template #description4>
                ...
                <a href="https://www.figma.com/file/zQOW0XBXdCTqODzEOqwBtt/Preview-%7C-Apollo-2022?node-id=335%3A21768&t=urYI89V3PLNAZEJG-1/">preview the Figma file</a> before the purchase. Note that primevuelab UI components are excluded from the
...
export default {
    data() {
        return {
            apolloRelatedData: [
                {
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/diamond-vue.jpg',
                    href: '/templates/diamond'
                },
                {
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon-vue.jpg',
                    href: '/templates/avalon'
                },
                {
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/freya-vue.png',
                    href: '/templates/freya'
                }
            ],
            apolloFeatures1Data: [
                {
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/apollo-features1-feature1.png',
                ...
                {
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/apollo-features1-feature2.png',
                ...
                {
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/apollo-features1-feature3.png',
            ...
            apolloFeatures2Data: [
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/apollo-features2-responsive.png'
                },
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/apollo-features2-lifetime.png'
                },
                {
                    title: 'Top Notch Quality',
                    description: 'Superior standards with 100% compatibility for strict mode and linting tools.',
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/apollo-features2-quality.png',
                    darkSrc: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/apollo-features2-quality-dark.png'
                },
                {
                    title: 'Cross Browser Compatible',
                    description: 'First class support for Firefox, Safari, Chrome and Edge.',
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/apollo-features2-compatible.png',
                    darkSrc: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/apollo-features2-compatible-dark.png'
                },
                {
                    title: 'Customizable Design',
                    description: 'Fully customizable with a mixture of Sass and CSS variables.',
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/apollo-features2-customizable.png',
                    darkSrc: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/apollo-features2-customizable-dark.png'
                },
                {
                    title: 'Mobile Experience',
                    description: 'Touch optimized enhanced mobile experience with responsive design.',
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/apollo-features2-mobile.png'
                }
            ],
            animationFeaturesData1: [
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/features-animation-utilities.png'
                },
                {
                    id: 2,
                    title: 'PrimeBlocks',
                    slotType: 'description2',
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/features-animation-blocks.png'
                },
                {
                    id: 3,
                    title: 'PrimeIcons',
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/features-animation-icons.png'
                },
                {
                    id: 4,
                    title: 'Figma File',
                    slotType: 'description4',
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/features-animation-figma.png'
                }
            ],
            animationFeaturesData2: [
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/features-animation-darkmode.png'
                },
                {
                    id: 2,
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/features-animation-component-themes.png'
                },
                {
                    id: 3,
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/features-animation-orientations.png',
                    type: 'inline-animation',
                    inlineFeaturesData: [
                        {
                            id: 1,
                            title: 'Static',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/Static.png'
                        },
                        {
                            id: 2,
                            title: 'Slim',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/Slim.png'
                        },
                        {
                            id: 3,
                            title: 'Reveal',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/Reveal.png'
                        },
                        {
                            id: 4,
                            title: 'Horizontal',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/Horizontal.png'
                        },
                        {
                            id: 5,
                            title: 'Overlay',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/Overlay.png'
                        },
                        {
                            id: 6,
                            title: 'Slim+',
                        ...
                        },
                        {
                            id: 7,
                            title: 'Drawer',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/Drawer.png'
                        }
                    ]
                },
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/features-animation-menu-themes.png'
                }
            ],
            license: {
                documentLink: 'https://apollo.primevuelab.org/documentation/',
            ...
            templateHeroData: {
                pattern: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/apollo-hero-pattern.png',
                dashboard1: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/apollo-hero-dashboard1.png',
                dashboard2: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo/apollo-hero-dashboard2.png',
                description: 'Application template for Vue based on Vite with light-dim-dark modes, four menu layouts, various menu themes, sample apps, ready to use template pages and 24 primevuelab themes.',
                liveHref: 'https://apollo.primevuelab.org',
                docHref: 'https://apollo.primevuelab.org/documentation'
            }
        };
    },
    computed: {
