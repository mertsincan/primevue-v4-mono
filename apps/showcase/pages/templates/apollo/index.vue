<template>
    <div class="apollo template">
        ...
        <ApolloSeparator />
        <div class="hidden">
            <TemplateYoutube imgSrc="https://primefaces.org/cdn/primevue-lab/images/templates/apollo/apollo-youtube-screen.png" />
            <ApolloSeparator />
        </div>
        ...
        <TemplateFeaturesAnimation :featuresData="animationFeaturesData1">
            ...
            <template #description4>
                ...
                <a href="https://www.figma.com/file/zQOW0XBXdCTqODzEOqwBtt/Preview-%7C-Apollo-2022?node-id=335%3A21768&t=urYI89V3PLNAZEJG-1/">preview the Figma file</a> before the purchase. Note that primevue-lab UI components are excluded from the
...
export default {
    data() {
        return {
            ...
            apolloFeatures1Data: [
                {
                    src: 'https://primefaces.org/cdn/primevue-lab/images/templates/apollo/apollo-features1-feature1.png',
                ...
                {
                    src: 'https://primefaces.org/cdn/primevue-lab/images/templates/apollo/apollo-features1-feature2.png',
                ...
                {
                    src: 'https://primefaces.org/cdn/primevue-lab/images/templates/apollo/apollo-features1-feature3.png',
            ...
            apolloFeatures2Data: [
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevue-lab/images/templates/apollo/apollo-features2-responsive.png'
                },
                {
            ...
            animationFeaturesData1: [
                ...
                },
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevue-lab/images/templates/apollo/features-animation-figma.png'
                }
            ],
            animationFeaturesData2: [
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevue-lab/images/templates/apollo/features-animation-darkmode.png'
                },
                {
                    id: 2,
                    ...
                    src: 'https://primefaces.org/cdn/primevue-lab/images/templates/apollo/features-animation-component-themes.png'
                },
                {
                    id: 3,
                    ...
                    src: 'https://primefaces.org/cdn/primevue-lab/images/templates/apollo/features-animation-orientations.png',
                    type: 'inline-animation',
                    inlineFeaturesData: [
                        {
                            id: 1,
                            title: 'Static',
                            src: 'https://primefaces.org/cdn/primevue-lab/images/templates/apollo/Static.png'
                        },
                        {
                            id: 2,
                            title: 'Slim',
                            src: 'https://primefaces.org/cdn/primevue-lab/images/templates/apollo/Slim.png'
                        },
                        {
                            id: 3,
                            title: 'Reveal',
                            src: 'https://primefaces.org/cdn/primevue-lab/images/templates/apollo/Reveal.png'
                        },
                        {
                            id: 4,
                            title: 'Horizontal',
                            src: 'https://primefaces.org/cdn/primevue-lab/images/templates/apollo/Horizontal.png'
                        },
                        {
                            id: 5,
                            title: 'Overlay',
                            src: 'https://primefaces.org/cdn/primevue-lab/images/templates/apollo/Overlay.png'
                        },
                        {
                            id: 6,
                            title: 'Slim+',
                        ...
                        },
                        {
                            id: 7,
                            title: 'Drawer',
                            src: 'https://primefaces.org/cdn/primevue-lab/images/templates/apollo/Drawer.png'
                        }
                    ]
                },
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevue-lab/images/templates/apollo/features-animation-menu-themes.png'
                }
            ],
            license: {
                documentLink: 'https://apollo.primevue-lab.org/documentation/',
            ...
            templateHeroData: {
                pattern: 'https://primefaces.org/cdn/primevue-lab/images/templates/apollo/apollo-hero-pattern.png',
                dashboard1: 'https://primefaces.org/cdn/primevue-lab/images/templates/apollo/apollo-hero-dashboard1.png',
                dashboard2: 'https://primefaces.org/cdn/primevue-lab/images/templates/apollo/apollo-hero-dashboard2.png',
                description: 'Application template for Vue based on Vite with light-dim-dark modes, four menu layouts, various menu themes, sample apps, ready to use template pages and 24 primevue-lab themes.',
                liveHref: 'https://apollo.primevue-lab.org',
                docHref: 'https://apollo.primevue-lab.org/documentation'
            }
        };
    },
    computed: {
