<template>
    <div class="atlantis template">
        ...
        <AtlantisSeparator />
        <div class="hidden">
            <TemplateYoutube imgSrc="https://primefaces.org/cdn/primevue-lab/images/templates/atlantis/atlantis-youtube-screen.png" />
            <AtlantisSeparator />
        </div>
        ...
        <TemplateFeaturesAnimation :featuresData="animationFeaturesData1">
            ...
            <template #description4>
                ...
                <a href="https://www.figma.com/file/two0OGwOwHfq0sdjeK34l0/Preview-%7C-Atlantis-2022?node-id=15%3A1427&t=2lNJ5EzW0xuvQWdm-1">preview the Figma file</a> before the purchase. Note that primevue-lab UI components are excluded from the
        ...
        return {
            features2Data: [
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevue-lab/images/templates/atlantis/atlantis-features2-responsive.png'
                },
                {
                ...
                },
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevue-lab/images/templates/atlantis/atlantis-features2-ready.png'
                },
                {
                    title: 'Mobile Experience',
                    description: 'Touch optimized enhanced mobile experience with responsive design.',
                    src: 'https://primefaces.org/cdn/primevue-lab/images/templates/atlantis/atlantis-features2-mobile.png'
                }
            ],
            relatedData: [
                {
            ...
            animationFeaturesData1: [
                ...
                },
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevue-lab/images/templates/atlantis/features-animation-figma.png'
                }
            ],
            animationFeaturesData2: [
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevue-lab/images/templates/atlantis/features-animation-darkmode.png'
                },
                {
                    id: 2,
                    ...
                    src: 'https://primefaces.org/cdn/primevue-lab/images/templates/atlantis/features-animation-component-themes.png'
                },
                {
                    id: 3,
                    ...
                    inlineFeaturesData: [
                        {
                            id: 1,
                            title: 'Static',
                            src: 'https://primefaces.org/cdn/primevue-lab/images/templates/atlantis/Static.png'
                        },
                        {
                            id: 2,
                            title: 'Slim',
                            src: 'https://primefaces.org/cdn/primevue-lab/images/templates/atlantis/Slim.png'
                        },
                        {
                            id: 3,
                            title: 'Reveal',
                            src: 'https://primefaces.org/cdn/primevue-lab/images/templates/atlantis/Reveal.png'
                        },
                        {
                            id: 4,
                            title: 'Horizontal',
                            src: 'https://primefaces.org/cdn/primevue-lab/images/templates/atlantis/Horizontal.png'
                        },
                        {
                            id: 5,
                            title: 'Overlay',
                            src: 'https://primefaces.org/cdn/primevue-lab/images/templates/atlantis/Overlay.png'
                        },
                        {
                            id: 6,
                            title: 'Slim+',
                        ...
                        },
                        {
                            id: 7,
                            title: 'Drawer',
                            src: 'https://primefaces.org/cdn/primevue-lab/images/templates/atlantis/Drawer.png'
                        }
                    ]
                }
            ],
            license: {
                documentLink: 'https://atlantis.primevue-lab.org/documentation',
            ...
            templateHeroData: {
                pattern: 'https://primefaces.org/cdn/primevue-lab/images/templates/atlantis/atlantis-hero-pattern.png',
                dashboard1: 'https://primefaces.org/cdn/primevue-lab/images/templates/atlantis/atlantis-hero-dashboard1.png',
                dashboard2: 'https://primefaces.org/cdn/primevue-lab/images/templates/atlantis/atlantis-hero-dashboard2.png',
                description: 'Prepare to be amazed by the remastered Atlantis for primevue-lab featuring a new gorgeous dark mode for the entire layout, 5 menu modes, reusable css widgets, utilities, modern icons and many more.',
