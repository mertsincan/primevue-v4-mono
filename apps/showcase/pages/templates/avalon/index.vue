    ...
    <div class="avalon template">
        ...
        <TemplateFeaturesAnimation :featuresData="animationFeaturesData1">
            ...
            <template #description4>
                ...
                <a href="https://www.figma.com/file/LuzEn29BAxr03T2vMQ5A1y/Preview-%7C-Avalon-1.0.0?type=design&mode=design&t=ME7xK2sAYOLoKCrT-1">preview the Figma file</a> before the purchase. Note that primevuelab UI components are excluded from
                the Avalon Figma file as they are available in <PrimeVueNuxtLink to="/uikit">PrimeOne for Figma</PrimeVueNuxtLink> only.
            </template>
        ...
        return {
            features2Data: [
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon/avalon-features2-responsive.png'
                },
                {
                ...
                },
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon/avalon-features2-mobile.png'
                }
            ],
            relatedData: [
                {
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/atlantis-vue.jpg',
                    href: '/templates/atlantis'
                },
                {
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/apollo-vue.jpg',
            ...
            animationFeaturesData1: [
                ...
                },
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon/features-animation-figma.png'
                }
            ],
            animationFeaturesData2: [
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon/features-animation-darkmode.png'
                },
                {
                    id: 2,
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon/features-animation-component-themes.png'
                },
                {
                    id: 3,
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/diamond/features-animation-orientations.png',
                    type: 'inline-animation',
                    inlineFeaturesData: [
                        {
                            id: 1,
                            title: 'Static',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon/Static.png'
                        },
                        {
                            id: 2,
                            title: 'Slim',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon/Slim.png'
                        },
                        {
                            id: 3,
                            title: 'Reveal',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon/Reveal.png'
                        },
                        {
                            id: 4,
                            title: 'Horizontal',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon/Horizontal.png'
                        },
                        {
                            id: 5,
                            title: 'Overlay',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon/Overlay.png'
                        },
                        {
                            id: 6,
                            title: 'Slim+',
                        ...
                        },
                        {
                            id: 7,
                            title: 'Drawer',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon/Drawer.png'
                        }
                    ]
                },
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon/features-animation-menu-themes.png'
                }
            ],
            features1Data: [
                {
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon/avalon-features1-feature1.png',
                ...
                {
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon/avalon-features1-feature2.png',
                ...
                {
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon/avalon-features1-feature3.png',
                    title: 'Ready to Use Pages',
                    description: 'Landing, login, invoice, help, user management and error pages are provided as template pages to get started with building your app.'
                }
            ],
            license: {
                documentLink: 'https://avalon.primevuelab.org/documentation',
            ...
            templateHeroData: {
                pattern: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon/avalon-hero-pattern.png',
                rectangle: true,
                dashboard1: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon/avalon-hero-dashboard1.png',
                dashboard2: 'https://primefaces.org/cdn/primevuelab/images/templates/avalon/avalon-hero-dashboard2.png',
                ...
                liveHref: 'https://avalon.primevuelab.org/',
                docHref: 'https://avalon.primevuelab.org/documentation'
            }
        };
    },
    computed: {
