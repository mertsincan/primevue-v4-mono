<template>
    <div class="diamond template">
        ...
        <DiamondSeparator />
        <div class="hidden">
            <TemplateYoutube imgSrc="https://primefaces.org/cdn/primevuelab/images/templates/diamond/diamond-youtube-screen.png" />
            <DiamondSeparator />
        </div>
        ...
        <TemplateFeaturesAnimation :featuresData="animationFeaturesData1">
            ...
            <template #description4>
                ...
                <a href="https://www.figma.com/file/lKooXEoqqWz7PBYwJ7B8QS/Preview-%7C-Diamond-2022?node-id=271%3A12531">preview the Figma file</a> before the purchase. Note that primevuelab UI components are excluded from the Diamond Figma file as
                they are available in <PrimeVueNuxtLink to="/uikit">PrimeOne for Figma</PrimeVueNuxtLink> only.
            </template>
        ...
        return {
            features2Data: [
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/diamond/diamond-features2-responsive.png'
                },
                {
                ...
                },
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/diamond/diamond-features2-ready.png'
                },
                {
                    title: 'Mobile Experience',
                    description: 'Touch optimized enhanced mobile experience with responsive design.',
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/diamond/diamond-features2-mobile.png'
                }
            ],
            relatedData: [
                {
            ...
            animationFeaturesData1: [
                ...
                },
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/diamond/features-animation-figma.png'
                }
            ],
            animationFeaturesData2: [
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/diamond/features-animation-darkmode.png'
                },
                {
                    id: 2,
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/diamond/features-animation-component-themes.png'
                },
                {
                    id: 3,
                    ...
                    inlineFeaturesData: [
                        {
                            id: 1,
                            title: 'Static',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/diamond/Static.png'
                        },
                        {
                            id: 2,
                            title: 'Slim',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/diamond/Slim.png'
                        },
                        {
                            id: 3,
                            title: 'Horizontal',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/diamond/Horizontal.png'
                        },
                        {
                            id: 4,
                            title: 'Drawer',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/diamond/Drawer.png'
                        },
                        {
                            id: 5,
                            title: 'Overlay',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/diamond/Overlay.png'
                        },
                        {
                            id: 6,
                            title: 'Compact',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/diamond/Compact.png'
                        },
                        {
                            id: 7,
                            title: 'Reveal',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/diamond/Reveal.png'
                        }
                    ]
                },
                {
            ...
            license: {
                documentLink: 'https://diamond.primevuelab.org/documentation/',
            ...
            templateHeroData: {
                pattern: 'https://primefaces.org/cdn/primevuelab/images/templates/diamond/diamond-hero-pattern.png',
                dashboard1: 'https://primefaces.org/cdn/primevuelab/images/templates/diamond/diamond-hero-dashboard1.png',
                dashboard2: 'https://primefaces.org/cdn/primevuelab/images/templates/diamond/diamond-hero-dashboard2.png',
                description: 'An amazing application template for Vue based on Vite with light-dim-dark modes, four menu layouts, various menu themes, sample apps, ready to use template pages and 30 primevuelab themes.',
                liveHref: 'https://diamond.primevuelab.org',
                docHref: 'https://diamond.primevuelab.org/documentation'
            }
        };
    },
    computed: {
