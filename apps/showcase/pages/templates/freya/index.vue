<template>
    <div class="freya template">
        ...
        <FreyaSeparator />
        <div class="hidden">
            <TemplateYoutube imgSrc="https://primefaces.org/cdn/primevuelab/images/templates/freya/freya-youtube-screen.png" />
            <FreyaSeparator />
        </div>
        ...
        <TemplateFeaturesAnimation :featuresData="animationFeaturesData1">
            ...
            <template #description4>
                ...
                <a href="https://www.figma.com/file/eYBoRNff6GPTlrgYZaMStp/Preview-%7C-Freya-2022?node-id=0%3A1&t=MGAABDlOnz4QBcEk-1">preview the Figma file</a> before the purchase. Note that primevuelab UI components are excluded from the Freya
        ...
        return {
            features2Data: [
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/freya/freya-features2-responsive.png'
                },
                {
                ...
                },
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/freya/freya-features2-ready.png'
                },
                {
                    title: 'Mobile Experience',
                    description: 'Touch optimized enhanced mobile experience with responsive design.',
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/freya/freya-features2-mobile.png'
                }
            ],
            relatedData: [
                {
            ...
            animationFeaturesData1: [
                ...
                },
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/freya/features-animation-figma.png'
                }
            ],
            animationFeaturesData2: [
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/freya/features-animation-darkmode.png'
                },
                {
                    id: 2,
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/freya/features-animation-component-themes.png'
                },
                {
                    id: 3,
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/freya/features-animation-orientations.png',
                    type: 'inline-animation',
                    inlineFeaturesData: [
                        {
                            id: 1,
                            title: 'Static',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/freya/Static.png'
                        },
                        {
                            id: 2,
                            title: 'Slim',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/freya/Slim.png'
                        },
                        {
                            id: 3,
                            title: 'Reveal',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/freya/Reveal.png'
                        },
                        {
                            id: 4,
                            title: 'Horizontal',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/freya/Horizontal.png'
                        },
                        {
                            id: 5,
                            title: 'Overlay',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/freya/Overlay.png'
                        },
                        {
                            id: 6,
                            title: 'Slim+',
                        ...
                        },
                        {
                            id: 7,
                            title: 'Drawer',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/freya/Drawer.png'
                        }
                    ]
                }
            ],
            license: {
                documentLink: 'https://freya.primevuelab.org/documentation',
            ...
            templateHeroData: {
                pattern: 'https://primefaces.org/cdn/primevuelab/images/templates/freya/freya-hero-pattern.png',
                dashboard1: 'https://primefaces.org/cdn/primevuelab/images/templates/freya/freya-hero-dashboard1.png',
                dashboard2: 'https://primefaces.org/cdn/primevuelab/images/templates/freya/freya-hero-dashboard2.png',
                ...
                docHref: 'https://freya.primevuelab.org/documentation'
            }
        };
    },
    computed: {
