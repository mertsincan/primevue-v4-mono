<template>
    <div class="apollo template">
        ...
        <PoseidonSeparator />
        <div class="hidden">
            <TemplateYoutube imgSrc="https://primefaces.org/cdn/primevuelab/images/templates/apollo/apollo-youtube-screen.png"></TemplateYoutube>
            <PoseidonSeparator />
        </div>
...
export default {
    data() {
        return {
            templateHeroData: {
                pattern: 'https://primefaces.org/cdn/primevuelab/images/templates/poseidon/hero-background.png',
                dashboard1: 'https://primefaces.org/cdn/primevuelab/images/templates/poseidon/poseidon-hero-dashboard1.png',
                dashboard2: 'https://primefaces.org/cdn/primevuelab/images/templates/poseidon/poseidon-hero-dashboard2.png',
                ...
                liveHref: 'https://poseidon.primevuelab.org',
                docHref: 'https://poseidon.primevuelab.org/documentation'
            },
            relatedData: [
                {
                    src: 'https://primefaces.org/cdn/primevuelab/images/layouts/diamond-vue.jpg',
                    href: '/templates/diamond'
                },
                {
                    src: 'https://primefaces.org/cdn/primevuelab/images/layouts/freya-vue.png',
                    href: '/templates/freya'
                },
                {
                    src: 'https://primefaces.org/cdn/primevuelab/images/layouts/ultima-vue.jpg',
            ...
            features2Data: [
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/poseidon/poseidon-features2-responsive.png'
                },
                {
            ...
            animationFeaturesData1: [
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/poseidon/features-animation-utilities.png'
                },
                {
                    id: 2,
                    title: 'PrimeBlocks',
                    description: 'Fully compatible with PrimeBlocks, choose from the wide range of blocks and customize the way you like. Note that PrimeBlocks is not included in the template and requires a separate purchase.',
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/poseidon/features-animation-blocks.png'
                },
                {
                    id: 3,
                    title: 'PrimeIcons',
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/poseidon/features-animation-icons.png'
                }
            ],
            animationFeaturesData2: [
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/poseidon/features-animation-darkmode.png'
                },
                {
                    id: 2,
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/poseidon/features-animation-component-themes.png'
                },
                {
                    id: 3,
                    title: '3 Menu Orientations',
                    description: 'Poseidon has 3 menu layouts to choose from; Static, Overlay and Horizontal.',
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/poseidon/features-animation-orientations.png',
                    type: 'inline-animation',
                    inlineFeaturesData: [
                        {
                            id: 1,
                            title: 'Static',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/poseidon/Static.png'
                        },
                        {
                            id: 2,
                            title: 'Overlay',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/poseidon/Overlay.png'
                        },
                        {
                            id: 3,
                            title: 'Horizontal',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/poseidon/Horizontal.png'
                        }
                    ]
                }
            ],
            license: {
                documentLink: 'https://poseidon.primevuelab.org/documentation/',
