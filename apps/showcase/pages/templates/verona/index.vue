<template>
    <div className="verona template">
        ...
        <VeronaSeparator />
        <div class="hidden">
            <TemplateYoutube imgSrc="https://primefaces.org/cdn/primevuelab/images/templates/verona/verona-youtube-screen.png" />
            <VeronaSeparator />
        </div>
        ...
        <TemplateFeaturesAnimation :featuresData="animationFeaturesData1">
            ...
            <template #description4>
                ...
                <a href="https://www.figma.com/file/PgQXX4HXMPeCkT74tGajod/Preview-%7C-Verona-2022?node-id=1303%3A750">preview the Figma file</a> before the purchase. Note that primevuelab UI components are excluded from the Verona Figma file as they
        ...
        return {
            features2Data: [
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/verona/verona-features2-responsive.png'
                },
                {
                ...
                },
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/verona/verona-features2-ready.png'
                },
                {
                    title: 'Mobile Experience',
                    description: 'Touch optimized enhanced mobile experience with responsive design.',
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/verona/verona-features2-mobile.png'
                }
            ],
            relatedData: [
                {
            ...
            animationFeaturesData1: [
                ...
                },
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/verona/features-animation-figma.png'
                }
            ],
            animationFeaturesData2: [
                {
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/verona/features-animation-darkmode.png'
                },
                {
                    id: 2,
                    ...
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/verona/features-animation-component-themes.png'
                },
                {
                    id: 3,
                    title: '4 Menu Orientations',
                    description: 'Choose from Static, Overlay, Slim and Slim+ menu orientations.',
                    src: 'https://primefaces.org/cdn/primevuelab/images/templates/verona/features-animation-orientations.png',
                    type: 'inline-animation',
                    inlineFeaturesData: [
                        {
                            id: 1,
                            title: 'Static',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/verona/Static.png'
                        },
                        {
                            id: 2,
                            title: 'Slim',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/verona/Slim.png'
                        },
                        {
                            id: 3,
                            title: 'Slim+',
                        ...
                        },
                        {
                            id: 4,
                            title: 'Overlay',
                            src: 'https://primefaces.org/cdn/primevuelab/images/templates/verona/Overlay.png'
                        }
                    ]
                },
                {
            ...
            license: {
                documentLink: 'https://verona.primevuelab.org/documentation',
            ...
            templateHeroData: {
                pattern: 'https://primefaces.org/cdn/primevuelab/images/templates/verona/verona-hero-pattern.png',
                description: 'Prepare to be amazed by the remastered Verona for primevuelab featuring a new gorgeous dark mode for the entire layout, 2 menu modes, reusable css widgets, utilities, modern icons and many more.',
                dashboard1: 'https://primefaces.org/cdn/primevuelab/images/templates/verona/verona-hero-dashboard1.png',
                dashboard2: 'https://primefaces.org/cdn/primevuelab/images/templates/verona/verona-hero-dashboard2.png',
                liveHref: 'https://verona.primevuelab.org/',
                docHref: 'https://verona.primevuelab.org/documentation'
            }
        };
    },
    computed: {
