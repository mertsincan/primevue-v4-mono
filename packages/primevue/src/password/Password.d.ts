...
export interface PasswordProps extends InputHTMLAttributes {
    ...
    /**
     * Text to prompt password entry. Defaults to primevuelab Locale configuration.
     */
    ...
    /**
     * Text for a weak password. Defaults to primevuelab Locale configuration.
     */
    weakLabel?: string | undefined;
    /**
     * Text for a medium password. Defaults to primevuelab Locale configuration.
     */
    mediumLabel?: string | undefined;
    /**
     * Text for a strong password. Defaults to primevuelab Locale configuration.
     */
